...
6. [Get (discover) all available remote devices](#server-query-to-get-all-available-remote-devices-per-user)
7. [Get (discover) the available resources from a specific device](#client-request-to-get-the-available-resources-from-a-specific-device)
...
$ npm install nodemon
```
2. Start your node process with *-config* flag.
...
3. Start your application using *npm start* command.
```js
$ npm start
```
